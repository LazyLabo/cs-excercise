...
７の５乗の答えを、すでにある関数を使って求めたいです。7 x 7 x 7 x 7 x 7 という式はつかってはいけません。その関数はどこにあるでしょう？どうやってその関数を使いますか？実際に７の５乗の値を求めましょう。

### ヒント

- この場合はJavaScriptにもともと定義されている Math オブジェクトの```pow()```関数を使います。pow は power of の約です。
- pow() 関数は２つの引数を取ります。
